    ...
    for model_path in model_list:
        ...
        with open(list_path, 'r') as list_file:
            for img_path in list_file:
                ...
                nocs_gt_path = os.path.join(data_dir, "data", "gts", "real_test",
                                            "results_real_test_" + scene + "_" + img_path.split("/")[
                                                -1] + ".pkl")
                ...
                if scene != scene_his:
                    ...
                    scene_num = 0
                    scene_in = 0
                pred_path = os.path.join(pred_data_dir, "temp_" + str(cls_idx),
                                         model_name + "_" + scene + "_" + str(model_num) + "_pose.txt")
                ...
                miou = compute_3d_iou_new(gt_pose, pred_pose, bbox, bbox, 1, synset_names[cls_idx],
                                          synset_names[cls_idx])
